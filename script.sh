...
gcc events/EventManager.c client/client.c client/tictactoe/tictactoe.c sdl-utils/SDLUtils.c $(sdl2-config --cflags --libs) -lSDL2_image -lSDL2_ttf -pthread  -o target/client.out
